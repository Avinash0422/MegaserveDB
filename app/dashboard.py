...
def process_data(df, time_period='Last Day', total_mtm_algo=None, total_mtm_servers=None, top_least_algo=None, top_least_servers=None, selected_user_id=None, dte_filter=None):
    ...
    try:
        ...
        # Apply filters for Summary card
        ...
        # Calculate total return: sum of MTM / sum of average allocations per user for filtered data
        ...
        # logger.debug(f"Summary Card - Total MTM: {total_mtm}, Total Allocation: {total_allocation}, Total Return %: {total_return_percent}")

        # Calculate Total AUM for Summary (unfiltered for summary metrics)
        ...
        # logger.debug(f"Summary Card - Total AUM: {total_aum_summary}")
        ...
        # Calculate Total AUM for Trading Statistics (filtered)
        ...
        # logger.debug(f"Trading Statistics Card - Total AUM: {total_aum}, Total MTM: {total_mtm_value}")
        ...
        mtm_vs_day_df = total_mtm_df.copy()  # Use the same filtered DataFrame for consistency
